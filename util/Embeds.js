  ...
  switch (type) {
    ...
    case 'summoned': {
      embed.setAuthor('Summoned')
        .setDescription(`${message.client.user.tag} has been forced to join ${message.member.voice.channel}`);
      break;
    }
    case 'unsummoned': {
      embed.setAuthor('Unsummoned')
        .setDescription(`${message.client.user.tag} has been forced to leave ${message.member.voice.channel}`);
      break;
    }
    case 'notDJ': {
      embed.setAuthor('Error')
